        ...
        const fn = (resolve, reject) => () => {
            ...
            this.client.request.get(url, { buffer: true }, (err, response, body) => {
                ...
                if (Date.now() - startTime + delay > timeout) {
                    return reject(new mailosaurError_js_1.default(`An email preview was not generated in time. The email client may not be available, or the preview ID [${previewId}] may be incorrect.`, 'preview_timeout'));
                }
