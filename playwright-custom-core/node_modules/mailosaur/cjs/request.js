...
class Request {
    constructor(options) {
        ...
        const httpProxy = process.env.https_proxy ||
            ...
            process.env.HTTP_PROXY;
        if (httpProxy) {
            this.proxyAgent = new https_proxy_agent_1.HttpsProxyAgent(httpProxy);
        }
    }
    ...
    invoke(options, callback) {
        ...
        const spread = Object.assign(Object.assign({}, options), { protocol: urlResult.protocol || undefined, hostname: urlResult.hostname || undefined, path: (urlResult.pathname || '') + (urlResult.search || '') });
